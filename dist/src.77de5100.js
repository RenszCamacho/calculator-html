...
var numberButtons = document.querySelectorAll(".box__number");
var operationButtons = document.querySelectorAll(".box__operator");
var equalsButton = document.querySelector("#equal");
var deleteButton = document.querySelector("#reset");
var allClearButton = document.querySelector("#AC");
var previousOperandTextElement = document.querySelector(".box__previousNum");
var currentOperandTextElement = document.querySelector(".box__currentNum");
var currentOperand = "";
var previousOperand = "";
...
var deleteNumber = function deleteNumber() {
...
var chooseOperation = function chooseOperation(operatorButton) {
...
var updateDisplay = function updateDisplay() {
  var previousOperandAsHtmlElement = previousOperandTextElement;
  var currentOperandAsHtmlElement = currentOperandTextElement;
  currentOperandAsHtmlElement.innerText = getDisplayNumber(currentOperand);

  if (operation !== undefined) {
    previousOperandAsHtmlElement.innerText = getDisplayNumber(previousOperand) + " " + operation;
  } else {
    previousOperandAsHtmlElement.innerText = "";
  }
};

var clickNumberButton = function clickNumberButton() {
  numberButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      var buttonAsHtmlElement = button;
...
var clickOperatorsButton = function clickOperatorsButton() {
...
var clickEqualsButton = function clickEqualsButton() {
...
var clickAllClearButton = function clickAllClearButton() {
...
var runCalculator = function runCalculator() {
  clickNumberButton();
...
require("./ts/main.ts");
},{"normalize.css":"../node_modules/normalize.css/normalize.css","./sass/main.scss":"sass/main.scss","./ts/main.ts":"ts/main.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
